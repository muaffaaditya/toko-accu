<?php 
include 'header.php';
$kode = mysqli_real_escape_string($conn,$_GET['produk_kapal']);
$result = mysqli_query($conn, "SELECT * FROM produk_kapal WHERE kode_produk = '$kode'");
...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-8">
			<form action="proses/add_kapal.php" method="GET">
				...
				?>
				<a href="accu_kapal.php" class="btn btn-warning"> Kembali Belanja</a>
			</div>
		</form>
	</div>
